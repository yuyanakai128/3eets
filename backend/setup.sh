...
docker run --name postgres -e POSTGRES_USER=postgres -e POSTGRES_PASSWORD=postgres -p 5432:5432 --network=iroha-network -d postgres:9.5 -c 'max_prepared_transactions=100'
